...
#roslaunch cartographer_ros jackal_3d.launch use_bag_file:=false &

roslaunch jackal_navigation amcl_demo.launch map_file:=$SF_DIR/KIST_map/L8_4.yaml laser_min_range:=0.3 laser_max_range:=35.0 initial_pose_x:=-9.0 initial_pose_y:=7.7 initial_pose_z:=0.0
